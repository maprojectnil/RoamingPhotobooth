...
import com.extremesolution.esptpcamera.PtpConstants.Product;
...
public class NikonGetLiveViewImageCommand extends NikonCommand {
    ...
    private static final boolean haveAddedDumpToAcra = false;
    ...
    public NikonGetLiveViewImageCommand(NikonCamera camera, LiveViewData data) {
        ...
        // PATCH (RoamingPhotobooth): sama seperti EosGetLiveViewPictureCommand --
        // tanpa ini, inBitmap di atas selalu gagal reuse (bitmap hasil decode
        // BitmapFactory secara default immutable) dan diam-diam fallback alokasi
        // baru tiap frame. Lihat NOTICE.md untuk detail lengkap.
