...
import com.extremesolution.esptpcamera.commands.GetDevicePropDescCommand;
import com.extremesolution.esptpcamera.commands.InitiateCaptureCommand;
import com.extremesolution.esptpcamera.commands.RetrieveAddedObjectInfoAction;
import com.extremesolution.esptpcamera.commands.SimpleCommand;
import com.extremesolution.esptpcamera.commands.nikon.NikonAfDriveCommand;
import com.extremesolution.esptpcamera.commands.nikon.NikonCloseSessionAction;
import com.extremesolution.esptpcamera.commands.nikon.NikonEventCheckCommand;
import com.extremesolution.esptpcamera.commands.nikon.NikonGetLiveViewImageAction;
import com.extremesolution.esptpcamera.commands.nikon.NikonGetLiveViewImageCommand;
import com.extremesolution.esptpcamera.commands.nikon.NikonOpenSessionAction;
import com.extremesolution.esptpcamera.commands.nikon.NikonStartLiveViewAction;
import com.extremesolution.esptpcamera.commands.nikon.NikonStopLiveViewAction;
...
//                    }
    ...
    public void onPropertyDescChanged(int property, DevicePropDesc desc) {
        if (!gotNikonShutterSpeed) {
            if (property == PtpConstants.Property.NikonShutterSpeed) {
                ...
                addPropertyMapping(Property.ShutterSpeed, PtpConstants.Property.NikonShutterSpeed);
                gotNikonShutterSpeed = true;
            } else if (property == PtpConstants.Property.ExposureTime) {
                addPropertyMapping(Property.ShutterSpeed, PtpConstants.Property.ExposureTime);
                gotNikonShutterSpeed = true;
            }
        }
    ...
    private void onPropertyCodesReceived(Set<Integer> properties) {
        ...
        addPropertyMapping(Property.ApertureValue, PtpConstants.Property.FNumber);
        addPropertyMapping(Property.IsoSpeed, PtpConstants.Property.ExposureIndex);
        addPropertyMapping(Property.Whitebalance, PtpConstants.Property.WhiteBalance);
        addPropertyMapping(Property.ColorTemperature, PtpConstants.Property.NikonWbColorTemp);
        addPropertyMapping(Property.ShootingMode, PtpConstants.Property.ExposureProgramMode);
        addPropertyMapping(Property.BatteryLevel, PtpConstants.Property.BatteryLevel);
        //addPropertyMapping(Camera.Property.AvailableShots, PtpConstants.Property);
        addPropertyMapping(Property.FocusMode, PtpConstants.Property.FocusMode);
        addPropertyMapping(Property.PictureStyle, PtpConstants.Property.NikonActivePicCtrlItem);
        addPropertyMapping(Property.ExposureMeteringMode, PtpConstants.Property.ExposureMeteringMode);
        addPropertyMapping(Property.FocusMeteringMode, PtpConstants.Property.FocusMeteringMode);
        addPropertyMapping(Property.CurrentFocusPoint, PtpConstants.Property.NikonFocusArea);
        addPropertyMapping(Property.CurrentExposureIndicator, PtpConstants.Property.NikonExposureIndicateStatus);
        addPropertyMapping(Property.ExposureCompensation, PtpConstants.Property.ExposureBiasCompensation);
