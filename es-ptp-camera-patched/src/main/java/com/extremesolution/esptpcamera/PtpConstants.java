...
public class PtpConstants {
    ...
    public static String codeToString(int type, int code) {
        switch (type) {
            ...
            default:
                return String.format(Locale.US, "0x%04x", code);
        }
    }
    ...
    public static String constantToString(Class<?> clazz, int constant) {
        String hexString = String.format(Locale.US, "0x%04x", constant);
        ...
        while ((line = reader.readLine()) != null) {
            if ("OperationsSupported:".equals(line)) {
                ...
                if (line.startsWith("    0x") || line.matches("    .+\\)$")) {
                    ...
                    writer.write(String.format(Locale.US, "    %s", value));
                } else {
                    writer.write(line);
                }
            }
    ...
    public static class Operation {
        ...
        public static final int EosGetObjectExif = 0x9107;
    ...
    public static class Event {
        ...
        // Canon EOS
        public static final int EosObjectAdded = 0xC181;
        public static final int EosObjectAddedV2 = 0xC1AB;
        public static final int EosObjectAddedV3 = 0xC1A7;
