...
import com.extremesolution.esptpcamera.commands.eos.EosEventCheckCommand;
import com.extremesolution.esptpcamera.commands.eos.EosGetLiveViewPictureCommand;
import com.extremesolution.esptpcamera.commands.eos.EosOpenSessionAction;
import com.extremesolution.esptpcamera.commands.eos.EosSetLiveViewAction;
import com.extremesolution.esptpcamera.commands.eos.EosSetPropertyCommand;
import com.extremesolution.esptpcamera.commands.eos.EosTakePictureCommand;
...
public class EosCamera extends PtpCamera {
    ...
    public EosCamera(PtpUsbConnection connection, CameraListener listener) {
        ...
        addPropertyMapping(Property.ShutterSpeed, PtpConstants.Property.EosShutterSpeed);
        addPropertyMapping(Property.ApertureValue, PtpConstants.Property.EosApertureValue);
        addPropertyMapping(Property.IsoSpeed, PtpConstants.Property.EosIsoSpeed);
        addPropertyMapping(Property.Whitebalance, PtpConstants.Property.EosWhitebalance);
        addPropertyMapping(Property.ShootingMode, PtpConstants.Property.EosShootingMode);
        addPropertyMapping(Property.AvailableShots, PtpConstants.Property.EosAvailableShots);
        addPropertyMapping(Property.ColorTemperature, PtpConstants.Property.EosColorTemperature);
        addPropertyMapping(Property.FocusMode, PtpConstants.Property.EosAfMode);
        addPropertyMapping(Property.PictureStyle, PtpConstants.Property.EosPictureStyle);
        addPropertyMapping(Property.ExposureMeteringMode, PtpConstants.Property.EosMeteringMode);
        addPropertyMapping(Property.ExposureCompensation, PtpConstants.Property.EosExposureCompensation);
    ...
    public void driveLens(int driveDirection, int pulses) {
        if (driveLensSupported && liveViewOpen) {
            int value = driveDirection == DriveLens.Near ? 0 : 0x8000;
            switch (pulses) {
                case DriveLens.Hard:
                    value |= 0x0003;
                    break;
