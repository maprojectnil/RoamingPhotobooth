...
public interface Camera {
    ...
    /**
     * Sets the center point of the autofocus frame in Live view.
     *
     * @param posx range 0.0 (left) - 1.0 (right)
     * @param posy range 0.0 (top) - 1.0 (bottom)
     */
    ...
    interface CameraListener {
        ...
        void onCameraFound(UsbDevice device);
        ...
        void onCapturedPictureReceived(int objectHandle, String filename, Bitmap thumbnail, Bitmap bitmap, int orientation);

        void onPictureRetrievalFailed(int objectHandle, String reason);
...
//        void onFocusPointsChanged();
    ...
    interface RetrieveImageInfoListener {
        void onImageInfoRetrieved(int objectHandle, ObjectInfo objectInfo, Bitmap thumbnail);
    }

    interface RetrieveImageListener {
        void onImageRetrieved(int objectHandle, Bitmap image, int objectOrientation);
    }
